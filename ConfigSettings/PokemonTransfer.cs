...
namespace ConfigSettings
{
    ...
    class PokemonTransferT
    {
        ...
        public PokemonTransferT(string Key, int KeepMinCp, int KeepMinLvl, bool UseKeepMinLvl, float KeepMinIvPercentage,
                                int KeepMinDuplicatePokemon, string[] Moves, Config.Operator KeepMinOperator)
        {
            this.Key = Key;
        ...
        public PokemonTransferT()
        {
            ...
            this.MovesToDisplay = "";
            this.KeepMinOperator = Config.Operator.and;
        }
    }
